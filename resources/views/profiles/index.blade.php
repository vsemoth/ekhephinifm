        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <h2>{{ __('User Profile') }} <a href="{{ route('profiles.create') }}" style="float: right;" class="btn btn-primary">Upload Image</a></h2>
                    @endif
                    @if(Auth::user()->profile)
                    <h2>{{ __('User Profile') }} <a href="{{ route('profiles.edit',Auth::user()->profile->id) }}" style="float: right;" class="btn btn-warning">Edit Profile</a></h2>
                    @endif
